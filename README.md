...
> 능력단위에서 중요한 단원이지만 시간이 더 필요한 경우 강사의 판단하에 다른 단원의 시간에서 일정 부분 할애 하여 진행 될수 있습니다. 예) 자바 수업 시간 확보가 필요한 경우 데이터베이스에서 하루 2시간씩 시간 확보<br>**보충 학습**은 수업에서 다뤄야할 정규 과정은 아니지만 개발자로 취업을 위한 소양으로 강사가 판단하기에 필요하다고 생각하는 내용입니다. 각 수업 능력 단위 중간 중간 도입될 수 있으며, 일부 과정은 시간이 부족할 경우 경중에 따라 진행되지 않을 수도 있습니다. 
